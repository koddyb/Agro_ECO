...
<html class="no-js" lang="zxx">
    ...
    <body>
        ...
        String destination = null;
     	...
     	// V�rification des informations de connexion si le bouton "Connexion" a �t� cliqu�
        if (request.getParameter("Connexion") != null) {
            // R�cup�ration des param�tres email et mot de passe soumis par le formulaire
            String email = request.getParameter("email");
            String password = request.getParameter("password");

            // Appel de la m�thode pour v�rifier les informations de connexion
            User unUser = Controleur.verifConnexion(email, password);

            // Si un utilisateur correspondant est trouv�
            if (unUser != null) {
                // On v�rifie le statut de l'utilisateur
                ...
                if ("confirmed".equals(status)) {
                    // Ajouter l'ID de l'utilisateur connect� dans la session
                    ...
                    // Redirection vers la destination appropri�e apr�s connexion
                    response.sendRedirect(destination);
                    return;
                }

                // Si le statut est "suspended", l'acc�s est bloqu�
                    ...
                    <div class="col-lg-5">
                        <div class="contact-info" style="background: url(${pageContext.request.contextPath}/assets/img/bg/footer-bg.png) no-repeat;background-size: cover;">
                            <div class="single-cta pb-30 mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                                ...
                                <p>Celle que vous avez fournis pour la creation de votre compte</p>
                            </div>
                            <div class="single-cta pb-30 mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                                <div class="f-cta-icon">
                                ...
                                <p>Si vous etes nouveau? renseignez le mot de passe fourni par votre administrateur, sinon, entrer le votre</p>
                            </div>
                            <!-- <div class="single-cta pb-30 mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                                <div class="f-cta-icon">
